  ...
  return (
    <div className="relative group perspective-1000">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8 pb-3 border-b border-white/5">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            {[Copy, Sun, Settings, Pin].map((Icon, i) => (
              <div
                key={i}
                className="p-1.5 sm:p-2 rounded-lg bg-white/5 border border-white/5 text-white/40 hover:text-white/80 transition-colors"
              >
        ...
        <div className="flex-1 rounded-2xl bg-black/40 border border-white/5 p-5 font-mono text-sm leading-relaxed">
